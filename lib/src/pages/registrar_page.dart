...
// sirve para coger todo el alto y ancho de la pantalla
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            SizedBox(
              height: 10.0,
              width: double.infinity, // con esto se pone en el centro
            ),
            Text(
              'David Onofre',
  ...
  Widget _loginForm(context) {
    // Busca la instancia del provider y la trae
      ...
      builder: (BuildContext context, AsyncSnapshot snapshot) {
        return Container(
          ...
          child: TextField(
            ...
            //onChanged: bloc.changeEmail, Esto hace lo mismo que la linea de arriba
          ),
        );
      },
    );
  ...
  _registrar(LoginBloc bloc, BuildContext context) async {
    ...
    usuarioProvider.verificarCorreo();
    if (info['ok']) {
